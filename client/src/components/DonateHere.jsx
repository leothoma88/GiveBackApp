      ...
      <div className="card bg-red-900 grid grid-cols-2 m-14 rounded-lg">
        <form className="payment-form">
          ...
          <div className="flex flex-col payment-selection m-10 justify-items-center">
            <button
              type="button"
              className="credit-card border-y-2 border-black  bg-white"
            >
              <BsCreditCard />
              Credit Card
            </button>
            <button
              type="button"
              className="bank border-y-0 border-black bg-white"
            >
              <BsBank />
              Bank
            </button>
            <button
              type="button"
              className="paypal border-y-2 border-black bg-white"
            >
              <FaPaypal />
              PayPal
            </button>
